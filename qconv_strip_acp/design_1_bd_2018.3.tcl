...
ikwzm:QCONV:QCONV_STRIP_AXI:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: ZYNQMP_ACP_ADAPTER, and set properties
  set ZYNQMP_ACP_ADAPTER [ create_bd_cell -type ip -vlnv ikwzm:PIPEORK:ZYNQMP_ACP_ADAPTER:0.4 ZYNQMP_ACP_ADAPTER ]
  ...
  # Create instance: qconv_strip_axi_0, and set properties
  set qconv_strip_axi_0 [ create_bd_cell -type ip -vlnv ikwzm:QCONV:QCONV_STRIP_AXI:1.0 qconv_strip_axi_0 ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net ZYNQMP_ACP_ADAPTER_ACP [get_bd_intf_pins ZYNQMP_ACP_ADAPTER/ACP] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_ACP_FPD]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins qconv_strip_axi_0/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_acp_M00_AXI [get_bd_intf_pins ZYNQMP_ACP_ADAPTER/AXI] [get_bd_intf_pins axi_interconnect_acp/M00_AXI]
  connect_bd_intf_net -intf_net qconv_strip_axi_0_IO_AXI [get_bd_intf_pins axi_interconnect_acp/S00_AXI] [get_bd_intf_pins qconv_strip_axi_0/IO_AXI]
  connect_bd_intf_net -intf_net qconv_strip_axi_0_K_AXI [get_bd_intf_pins axi_interconnect_acp/S01_AXI] [get_bd_intf_pins qconv_strip_axi_0/K_AXI]
  connect_bd_intf_net -intf_net qconv_strip_axi_0_T_AXI [get_bd_intf_pins axi_interconnect_acp/S02_AXI] [get_bd_intf_pins qconv_strip_axi_0/T_AXI]
  ...
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_acp/ARESETN] [get_bd_pins axi_interconnect_acp/M00_ARESETN] [get_bd_pins axi_interconnect_acp/S00_ARESETN] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins ZYNQMP_ACP_ADAPTER/ARESETn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect_acp/S01_ARESETN] [get_bd_pins axi_interconnect_acp/S02_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins qconv_strip_axi_0/ARESETn]
  connect_bd_net -net qconv_strip_axi_0_interrupt [get_bd_pins qconv_strip_axi_0/interrupt] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins ZYNQMP_ACP_ADAPTER/ACLK] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_acp/ACLK] [get_bd_pins axi_interconnect_acp/M00_ACLK] [get_bd_pins axi_interconnect_acp/S00_ACLK] [get_bd_pins axi_interconnect_acp/S01_ACLK] [get_bd_pins axi_interconnect_acp/S02_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins qconv_strip_axi_0/ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxiacp_fpd_aclk]
  ...
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces ZYNQMP_ACP_ADAPTER/ACP] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIACP/ACP_DDR_LOW] SEG_zynq_ultra_ps_e_0_ACP_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces ZYNQMP_ACP_ADAPTER/ACP] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIACP/ACP_LPS_OCM] SEG_zynq_ultra_ps_e_0_ACP_LPS_OCM
  create_bd_addr_seg -range 0x000100000000 -offset 0x00000000 [get_bd_addr_spaces qconv_strip_axi_0/IO_AXI] [get_bd_addr_segs ZYNQMP_ACP_ADAPTER/AXI/reg0] SEG_ZYNQMP_ACP_ADAPTER_reg0
  create_bd_addr_seg -range 0x000100000000 -offset 0x00000000 [get_bd_addr_spaces qconv_strip_axi_0/K_AXI] [get_bd_addr_segs ZYNQMP_ACP_ADAPTER/AXI/reg0] SEG_ZYNQMP_ACP_ADAPTER_reg0
  create_bd_addr_seg -range 0x000100000000 -offset 0x00000000 [get_bd_addr_spaces qconv_strip_axi_0/T_AXI] [get_bd_addr_segs ZYNQMP_ACP_ADAPTER/AXI/reg0] SEG_ZYNQMP_ACP_ADAPTER_reg0
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xA0001000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs qconv_strip_axi_0/S_AXI/reg0] SEG_qconv_strip_axi_0_reg0
